...
from Utility import  florence_single_embedding
...
if 'index' not in st.session_state:
    st.session_state['Index'] = LocalAnnoyIndex(function_embedding=florence_single_embedding,vector_size=1024)
...
with st.sidebar:
    ...
    if uploaded_file is not None:
        ...
        features = st.session_state['Index'].Search_AnnoyIndex(BytesIO(file_content).read(),n=10)
        similar=True
        st.write(features)
